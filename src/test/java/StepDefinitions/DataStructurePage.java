...
import PageObjectfiles.DataStructurePageObject;
...
public class DataStructurePage {
	...
	public DataStructurePage(Textcontextclass textcontext) {
		this.textcontext = textcontext;
		this.obj = textcontext.pageobject.DataStructurePageObject();
	}
